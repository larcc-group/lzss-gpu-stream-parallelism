    ...
    for j,mode  in enumerate(["memory","file"]):
        ...
        for i,plan in enumerate(plans):
            ...
            for dataset in datasets:
                vec = dataset_helper.select_vector("SELECT finding_match FROM result WHERE plan ='{0}' and dataset = '{1}' and mode='{2}'".format(plan,dataset,mode))
...
plt.savefig("img/lzss_finding_match.pdf",bbox_inches='tight', transparent="True", pad_inches=0)
